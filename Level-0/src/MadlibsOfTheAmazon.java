...
public class MadlibsOfTheAmazon {
	public static void main(String[] args) {
		...
		JOptionPane.showMessageDialog(null, "If you find yourself having to cross a piranha-infested river, here's how you'd do it.");
		...
		"\n Piranhas are attracted to fresh " + Liquid + ", and will most likely take a bite out of your " + BodyPart + "\n if you start to " + Verb +
		". Whatever you do, if you have an open wound, try to find another way to get back to  " + Place + ".");
